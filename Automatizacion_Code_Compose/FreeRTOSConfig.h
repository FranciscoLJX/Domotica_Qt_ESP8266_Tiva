...
#define configQUEUE_REGISTRY_SIZE               0 // Define el mÃ¡ximo nÃºmero de colas y semÃ¡foros que se pueden registrar en el sistema de depuracion

#define configUSE_CO_ROUTINES               0 // 1/0: Activa el uso de mecanismos de corrutinas
#define configMAX_CO_ROUTINE_PRIORITIES     ( 2 ) // Indica el nÃºmero de prioridades que podrÃ¡n tener las tareas que funcionen como corrutinas
...
#define configTIMER_QUEUE_LENGTH		32 // TamaÃ±o de la cola de comandos de control de Timers SW
#define configTIMER_TASK_STACK_DEPTH	( configMINIMAL_STACK_SIZE * 2 ) // TamaÃ±o de la pila de la tarea interna que gestiona los timer SW


#define configUSE_STATS_FORMATTING_FUNCTIONS 1 // 1/0: Formateo de parÃ¡metros estadÃ­sticos recogidos en depuraciÃ³n
